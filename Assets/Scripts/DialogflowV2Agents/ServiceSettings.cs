...
[CreateAssetMenu(fileName = "S2TAccessSettings", menuName = "GCP Speech To Text/Access Settings")]
public class ServiceSettings : ScriptableObject
{
    ...
    [SerializeField] private string credentialsFileName = "";
    ...
    [SerializeField] private string serviceAccount = "";
